...
<#if swagger2>    @ApiOperation(value = "查询${entity}Entity")</#if>
    ...
    public ServiceResult<IPage> get${entity}EntityPage(Page<${entity}Entity> page, ${entity}Entity ${cfg.camelTableName}){
...
<#if swagger2>    @ApiOperation(value = "新增${entity}Entity")</#if>
    ...
    public ServiceResult create(@Valid @RequestBody ${entity}Entity ${cfg.camelTableName}, BindingResult bindingResult){
...
<#if swagger2>    @ApiOperation(value = "修改${entity}Entity")</#if>
    ...
    public ServiceResult update(@Valid @RequestBody ${entity}Entity ${cfg.camelTableName}, BindingResult bindingResult){
        if (bindingResult.hasErrors()) {
            List<FieldError> fieldErrors = bindingResult.getFieldErrors();
            return WrapMapper.error(GsonUtils.toJsonString(fieldErrors));
         }
